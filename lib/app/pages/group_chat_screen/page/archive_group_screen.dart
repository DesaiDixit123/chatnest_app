...
class ArchiveGroupScreen extends StatelessWidget {
  const ArchiveGroupScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return GetBuilder<GroupChatController>(
      initState: (state) {
        ...
        controller.postArchiveGroupChatList();
      },
      builder: (controller) {
        return Scaffold(
                  ...
                  return Padding(
                    ...
                    child: GestureDetector(
                      onLongPressStart: (details) {
                        ChatScreenUtility.ArchiveRemoveGroupChat(
                            context, details, item);
                      },
                      child: ListTile(
                        onTap: () {
                          RouteManagement.goToGroupChatScreen(item.id ?? "");
                        },
                        isThreeLine: true,
                        dense: true,
