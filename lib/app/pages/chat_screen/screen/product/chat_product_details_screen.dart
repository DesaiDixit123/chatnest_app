...
class ChatProductDetailsScreen extends StatelessWidget {
  const ChatProductDetailsScreen({super.key});
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      // (controller.allVideoList.length) > 0
                      //     ? SizedBox(
                      ...
                      Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            imageUrl:
                                ApiWrapper.imageUrl + (productData.image ?? ""),
                            fit: BoxFit.cover,
