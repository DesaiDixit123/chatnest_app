...
class ForgotLockChatScreen extends StatelessWidget {
  const ForgotLockChatScreen({super.key});
      ...
      return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            Dimens.boxHeight10,
            Text(
              "Check your email to know your otp.".tr,
              style: Styles.black40014,
            ),
            Dimens.boxHeight30,
