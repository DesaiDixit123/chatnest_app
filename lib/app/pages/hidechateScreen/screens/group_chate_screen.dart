...
class GroupCheatScreen extends StatelessWidget {
  const GroupCheatScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<HideChatController>(initState: (state) {
      ...
      controller.groupHidePagingController = PagingController(firstPageKey: 1);
      controller.groupHidePagingController
          .addPageRequestListener((pagekey) async {
        await controller.postGroupChatHideList(pagekey);
      });
    }, builder: (controller) {
      return Scaffold(
              ...
              children: [
                  ...
                  children: [
                    Expanded(
                      child: CustomTextFormField(
                        controller: controller.grouphideSearchController,
                        hintText: 'search'.tr,
                        ...
                        onChanged: (value) {
                          _debouncer.run(() {
                            Future.sync(
                              () {
                                return controller.groupHidePagingController
                                    .refresh();
                              },
                            );
                          });
                ...
                Expanded(
                  ...
                  onRefresh: () => Future.sync(
                    () => controller.groupHidePagingController.refresh(),
                  ),
                   color: ColorsValue.appColor,
                  child: PagedListView<int, GroupFriendData>(
                    pagingController: controller.groupHidePagingController,
                      ...
                      return Padding(
                        ...
                        child: GestureDetector(
                          onLongPressStart: (details) {
                            ChatScreenUtility.pinUnpinGroupChatHide(
