...
class ReplayPhoneContactMessage extends StatefulWidget {
  ...
  @override
  State<ReplayContactMessage> createState() => _ReplayContactMessageState();
}

class _ReplayContactMessageState extends State<ReplayContactMessage> {
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Dimens.boxWidth12,
                            Text(
                              widget.chatListsDocData.content?.contact[0]
                                      .userdata?.mobile ??
                                  "",
