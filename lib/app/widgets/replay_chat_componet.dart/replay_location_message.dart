...
class ReplayLocationMessage extends StatefulWidget {
  ...
  @override
  State<ReplayLocationMessage> createState() => _ReplayLocationMessageState();
}

class _ReplayLocationMessageState extends State<ReplayLocationMessage> {
                      ...
                      child: ClipRRect(
                        ...
                        child: GoogleMap(
                          ...
                          initialCameraPosition: CameraPosition(
                            target: LatLng(
                              widget.chatListsDocData.content?.location
                                  .coordinates[1],
                              widget.chatListsDocData.content?.location
                                  .coordinates[0],
                            ),
  ...
  void onMapCreated(GoogleMapController controller) {
    ...
    moveToLocation(
      LatLng(
        widget.chatListsDocData.content?.location.coordinates[1],
        widget.chatListsDocData.content?.location.coordinates[0],
      ),
    );
  }
