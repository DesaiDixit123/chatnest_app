...
class ReplayVideoMessage extends StatefulWidget {
  ReplayVideoMessage({
    super.key,
  ...
  @override
  State<ReplayVideoMessage> createState() => _ReplayVideoMessageState();
}

class _ReplayVideoMessageState extends State<ReplayVideoMessage> {
                          ...
                          child: Stack(
                            children: [
                              VideoThumbnailWidget(
                                video: widget
                                        .chatListsDocData.content?.media.path ??
                                    "",
                              ),
                              Center(
                                child: InkWell(
