...
class ReplayPhotoMessage extends StatefulWidget {
  ReplayPhotoMessage({
    super.key,
  ...
  @override
  State<ReplayPhotoMessage> createState() => _ReplayPhotoMessageState();
}

class _ReplayPhotoMessageState extends State<ReplayPhotoMessage> {
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              Container(
                width: widget.chatListsDocData.context?.contentType ==
                        "productwithtext"
                    ? Dimens.twoHundredEighty
                      ...
                      child: ClipRRect(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            child: CachedNetworkImage(
                              imageUrl: ApiWrapper.imageUrl +
                                  (widget.chatListsDocData.content?.media
                                          .path ??
                                      ""),
                              fit: BoxFit.cover,
