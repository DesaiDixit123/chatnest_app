...
abstract class Dimens {
  ...
  static double twoHundredTwenty = 220;
  ...
  static double twoHundredFiftySix = 256;
  ...
  static EdgeInsets edgeInsetsLeft30 = EdgeInsets.only(left: fifty);

  static EdgeInsets edgeInsetsTopt10 = EdgeInsets.only(top: ten);

  static EdgeInsets edgeInsetsTopt05 = EdgeInsets.only(top: five);

  static EdgeInsets edgeInsetsTopt49 = EdgeInsets.only(top: fourtyNine);

  static EdgeInsets edgeInsetsTop20 = EdgeInsets.only(top: twenty);
  static EdgeInsets edgeInsetsTop50 = EdgeInsets.only(top: fifty);
  ...
  static EdgeInsets edgeInsetsBottom70 = EdgeInsets.only(bottom: seventy);

  static EdgeInsets edgeInsetsBottom10 = EdgeInsets.only(bottom: ten);
  static EdgeInsets edgeInsetsBottom12 = EdgeInsets.only(bottom: twelve);

  static EdgeInsets edgeInsetsBottom20 = EdgeInsets.only(bottom: twenty);

  static EdgeInsets edgeInsetsBottom22 = EdgeInsets.only(bottom: twentyTwo);

  static EdgeInsets edgeInsetsBottom25 = EdgeInsets.only(bottom: twentyFive);

  static EdgeInsets edgeInsetsLeft2 = EdgeInsets.only(left: two);

  static EdgeInsets edgeInsetsLeft3 = EdgeInsets.only(left: three);
  ...
  static EdgeInsets edgeInsetsRight60 = EdgeInsets.only(right: sixty);
  ...
  static EdgeInsets edgeInsets00_05_60_00 = EdgeInsets.fromLTRB(
    zero,
    five,
    sixty,
    zero,
  ...
  static EdgeInsets edgeInsets60_05_00_00 = EdgeInsets.fromLTRB(
    sixty,
    five,
    zero,
    zero,
  ...
  static EdgeInsets edgeInsets50_5_50_5 = EdgeInsets.fromLTRB(
    thirty,
    five,
    thirty,
    five,
  ...
  static EdgeInsets edgeInsets10_10_10_30 = EdgeInsets.fromLTRB(
    ten,
    ten,
    ten,
    thirty,
  ...
  static EdgeInsets edgeInsets10_10_30_05 = EdgeInsets.fromLTRB(
    ten,
    ten,
    thirty,
    five,
  );
  static EdgeInsets edgeInsets20_10_00_10 = EdgeInsets.fromLTRB(
    twenty,
    ten,
    zero,
    zero,
  ...
  static EdgeInsets edgeInsets00_00_20_10 = EdgeInsets.fromLTRB(
    zero,
    zero,
    twenty,
    ten,
  ...
  static EdgeInsets edgeInsets00_05_20_00 = EdgeInsets.fromLTRB(
    zero,
    five,
    twenty,
    zero,
  ...
  static EdgeInsets edgeInsets20_00_00_10 = EdgeInsets.fromLTRB(
    twenty,
    zero,
    zero,
    ten,
  ...
  static EdgeInsets edgeInsets00_00_00_10 = EdgeInsets.fromLTRB(
    twenty,
    zero,
    zero,
    ten,
  ...
  static EdgeInsets edgeInsets00_15_00_15 = EdgeInsets.fromLTRB(
    zero,
    fifteen,
    zero,
    fifteen,
  ...
  static EdgeInsets edgeInsets15_4_15_4 = EdgeInsets.fromLTRB(
    fifteen,
    four,
    fifteen,
    four,
  ...
  static EdgeInsets edgeInsets9_12_9_12 = EdgeInsets.fromLTRB(
    nine,
    twelve,
    nine,
    twelve,
  ...
  static EdgeInsets edgeInsets20_0_20_40 = EdgeInsets.fromLTRB(
    twenty,
    zero,
    twenty,
    fourty,
  ...
  static EdgeInsets edgeInsets10_07_0_0 = EdgeInsets.fromLTRB(
    ten,
    seven,
    zero,
    zero,
  ...
  static EdgeInsets edgeInsets20_45_0_20 = EdgeInsets.fromLTRB(
    twenty,
    fourtyFive,
    zero,
    twenty,
  ...
  static EdgeInsets edgeInsets0_10_0_20 = EdgeInsets.fromLTRB(
    zero,
    ten,
    zero,
    twenty,
  ...
  static EdgeInsets edgeInsets10_0_5_0 = EdgeInsets.fromLTRB(
    ten,
    zero,
    five,
    zero,
  ...
  static EdgeInsets edgeInsets16_10_0_16 = EdgeInsets.fromLTRB(
    sixteen,
    ten,
    zero,
    sixteen,
  ...
  static EdgeInsets edgeInsets20_24_15_20 = EdgeInsets.fromLTRB(
    ten,
    fifteen,
    ten,
    five,
  ...
  static EdgeInsets edgeInsets20_0_20_5 = EdgeInsets.fromLTRB(
    twenty,
    zero,
    twenty,
    five,
  ...
  static EdgeInsets edgeInsets11_5_11_5 = EdgeInsets.fromLTRB(
    eleven,
    five,
    eleven,
    five,
  ...
  static EdgeInsets edgeInsets20_0_20_85 = EdgeInsets.fromLTRB(
    twenty,
    zero,
    twenty,
    eightyFive,
  ...
  static EdgeInsets edgeInsets0_10_0_30 = EdgeInsets.fromLTRB(
    zero,
    ten,
    zero,
    thirty,
  ...
  static EdgeInsets edgeInsets20_18_20_18 = EdgeInsets.fromLTRB(
    twenty,
    eighteen,
    twenty,
    eighteen,
  ...
  static EdgeInsets edgeInsets25_30_25_30 = EdgeInsets.fromLTRB(
    twentyFive,
    thirty,
    twentyFive,
    thirty,
  ...
  static EdgeInsets edgeInsets20_20_20_15 = EdgeInsets.fromLTRB(
    twenty,
    twenty,
    twenty,
    fifteen,
  ...
  static EdgeInsets edgeInsets20_15_10_15 = EdgeInsets.fromLTRB(
    twenty,
    fifteen,
    ten,
    fifteen,
  ...
  static EdgeInsets edgeInsets20_15_0_15 = EdgeInsets.fromLTRB(
    twenty,
    fifteen,
    zero,
    fifteen,
  ...
  static EdgeInsets edgeInsets20_40_20_0 = EdgeInsets.fromLTRB(
    twenty,
    fourty,
    twenty,
    zero,
  ...
  static EdgeInsets edgeInsets60_290_60_0 = EdgeInsets.fromLTRB(
    sixty,
    twoHundredNinty,
    sixty,
    zero,
  ...
  static EdgeInsets edgeInsets5_5_20_5 = EdgeInsets.fromLTRB(
    five,
    five,
    twenty,
    five,
  ...
  static EdgeInsets edgeInsets15_07_15_07 = EdgeInsets.fromLTRB(
    fifteen,
    seven,
    fifteen,
    seven,
  ...
  static EdgeInsets edgeInsets16_08_16_08 = EdgeInsets.fromLTRB(
    sixteen,
    eight,
    sixteen,
    eight,
  ...
  static EdgeInsets edgeInsets40_0_20_0 = EdgeInsets.fromLTRB(
    fourty,
    zero,
    twenty,
    zero,
  ...
  static EdgeInsets edgeInsets7_0_7_0 = EdgeInsets.fromLTRB(
    seven,
    zero,
    seven,
    zero,
  ...
  static EdgeInsets edgeInsets30_30_30_20 = EdgeInsets.fromLTRB(
    thirty,
    thirty,
    thirty,
    twenty,
  ...
  static EdgeInsets edgeInsets40_20_40_20 = EdgeInsets.fromLTRB(
    fourty,
    twenty,
    fourty,
    twenty,
  ...
  static EdgeInsets edgeInsets10_05_30_20 = EdgeInsets.fromLTRB(
    ten,
    five,
    thirty,
    twenty,
  ...
  static EdgeInsets edgeInsets0_30_0_30 = EdgeInsets.fromLTRB(
    zero,
    thirty,
    zero,
    thirty,
  ...
  static SizedBox boxWidth25 = SizedBox(width: twentyFive);
  ...
  static SizedBox boxWidth90 = SizedBox(width: ninty);
  static SizedBox boxWidth100 = SizedBox(width: hundred);
  static SizedBox boxWidth101 = SizedBox(width: hundredOne);
  static SizedBox boxWidth105 = SizedBox(width: hundredFive);
  static SizedBox boxWidth108 = SizedBox(width: hundredEight);
  static SizedBox boxWidth110 = SizedBox(width: hundredTen);
  static SizedBox boxWidth134 = SizedBox(width: hundredThirtyFour);
  static SizedBox boxWidth125 = SizedBox(width: hundredTwentyFive);
  static SizedBox boxWidth130 = SizedBox(width: hundredThirty);
  static SizedBox boxWidth136 = SizedBox(width: hundredThirtySix);
  static SizedBox boxWidth137 = SizedBox(width: hundredThirtySeven);
  static SizedBox boxWidth140 = SizedBox(width: hundredFourty);
  static SizedBox boxWidth145 = SizedBox(width: hundredFourtyFive);
  static SizedBox boxWidth150 = SizedBox(width: hundredFifty);
  static SizedBox boxWidth158 = SizedBox(width: hundredFiftyEight);
  static SizedBox boxWidth170 = SizedBox(width: hundredSeventy);
  static SizedBox boxWidth190 = SizedBox(width: hundredNinty);
  static SizedBox boxWidth120 = SizedBox(width: hundredTwenty);
  static SizedBox boxWidth104 = SizedBox(width: hundredFour);
  static SizedBox boxWidth113 = SizedBox(width: hundredThirteen);
  ...
  static SizedBox boxHeight37 = SizedBox(height: thirtySeven);
  static SizedBox boxHeight40 = SizedBox(height: fourty);
  static SizedBox boxHeight43 = SizedBox(height: fourtyThree);
  ...
  static SizedBox boxHeight67 = SizedBox(height: sixtySeven);
  static SizedBox boxHeight70 = SizedBox(height: seventy);
